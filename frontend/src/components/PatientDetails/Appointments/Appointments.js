...
const Appointments = () => {
    ...
    useEffect(() => {
        ...
        const getUserData = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}appointment/list`, {
                method: "GET",
                headers: {
    ...
    useEffect(() => {
        ...
        const deleteAppointment = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}appointment/delete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer : ${authCtx.token}`
