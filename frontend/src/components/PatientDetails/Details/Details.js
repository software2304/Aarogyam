...
const Details = (props) => {
    ...
    useEffect(() => {
        ...
        const verify = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}user/verify`, {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            ], process.env.REACT_APP_WEB3_CONTRACT_ADDRESS || "0x6C0255B68bF9a4Fb4ab25713C9e8172033A462b9");
