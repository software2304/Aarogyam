...
const DoctorsList = () => {
    ...
    useEffect(() => {
        ...
        const getAll = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}doctor/list`, {
                method: "GET",
                headers: {
    ...
    useEffect(() => {
        ...
        const getQuery = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}doctor/query`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
