        ...
        <section id="hero">
            ...
            <div className='hero-content'>
                <div className='hero-text'>
                    <h1>Simplify your healthcare journey with Aarogyam</h1>
                    <p>Take control of your healthcare with Aarogyam. Securely track your medical history, schedule appointments, and receive personalized health recommendations.
                    </p>
