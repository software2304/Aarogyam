...
const Details = (props) => {
    ...
    useEffect(() => {
        ...
        async function connectToMetaMask() {
            ...
            const web3 = new Web3(new Web3.providers.HttpProvider(`${process.env.REACT_APP_WEB3_URL || "https://sepolia.infura.io/v3/3bf3c0bf24e64030975995fe8fbca6ba"}`));
            const provider = web3.currentProvider;
            // Get the signer
            const signer = web3.eth.accounts.privateKeyToAccount(process.env.REACT_APP_WEB3_PRIVATE_KEY || "b2fcb21107c2768a22ea5f878ff38a7dbf253094c21bb2289e3374d57e6e37c8");
    ...
    useEffect(() => {
        ...
        const verify = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}doctor/verify`, {
                method: "POST",
                headers: {
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            ], process.env.REACT_APP_WEB3_CONTRACT_ADDRESS || "0x6C0255B68bF9a4Fb4ab25713C9e8172033A462b9" || "0x6C0255B68bF9a4Fb4ab25713C9e8172033A462b9" );
