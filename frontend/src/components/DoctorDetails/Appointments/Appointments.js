...
const Appointments = () => {
    ...
    useEffect(() => {
        ...
        const getUserData = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}appointment/doctor/list`, {
                method: "GET",
                headers: {
    ...
    useEffect(() => {
        ...
        const deleteAppointment = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}appointment/doctor/delete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer : ${authCtx.token}`
    ...
    useEffect(() => {
        ...
        const finishAppointment = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:8080/"}appointment/doctor/complete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer : ${authCtx.token}`
